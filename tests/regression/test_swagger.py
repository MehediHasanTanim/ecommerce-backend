...
Three documentation endpoints must return HTTP 200 without authentication:
  • /api/v1/schema/            – raw OpenAPI schema (JSON/YAML)
  • /api/v1/docs/swagger/      – Swagger UI HTML
  • /api/v1/docs/redoc/        – ReDoc HTML
"""
...
class TestSwaggerDocs:
    ...
    def test_swagger_ui_returns_200(self, client):
        """GET /api/v1/docs/swagger/ → 200 OK with HTML body."""
    ...
    def test_swagger_does_not_require_auth(self, client):
        ...
        for path in ("/api/v1/schema/", "/api/v1/docs/swagger/", "/api/v1/docs/redoc/"):
